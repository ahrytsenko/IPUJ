...
public class RandomMosaicWalk2 {
    ...
    final static int ROWS = 50;        // Number of rows in mosaic.
    final static int COLUMNS = 50;     // Number of columns in mosaic.
    final static int SQUARE_SIZE = 10; // Size of each square in mosaic.
    final static int GREEN_ADDITION = 25; // Step for green color increasing
    ...
    public static void main(String[] args) {
        ...
        while (Mosaic.isOpen()) {
            ...
            changeToGreennerColor(currentRow, currentColumn);
            randomMove();
            Mosaic.delay(1);
        }
    }  // end main
    ...
    /**
     * Changes one square to a new color that is more greenner.
     * Precondition:   The specified rowNum and colNum are in the valid range
     *                 of row and column numbers.
     * Postcondition:  The square in the specified row and column has
     *                 been set to more greenner color.
